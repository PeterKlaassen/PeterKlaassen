...
document.getElementById("redBg").removeEventListener('click',attachEventToChangeColorRed);
document.getElementById("orangeBg").removeEventListener('click',attachEventToChangeColorOrange);
document.getElementById("purpleBg").removeEventListener('click',attachEventToChangeColorPurple);
document.getElementById("greenBg").removeEventListener('click',attachEventToChangeColorGreen);